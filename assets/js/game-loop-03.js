...
function updateMovement(p) {
    ...
    if (state.movement.x > SPEED) {
        state.movement.x = SPEED
    }
    else if (state.movement.x < -SPEED) {
        state.movement.x = -SPEED
    }
    if (state.movement.y > SPEED) {
        state.movement.y = SPEED
    }
    else if (state.movement.y < -SPEED) {
        state.movement.y = -SPEED
    }
}
